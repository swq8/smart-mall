...
public class AdminLogService {
    public void addLog(HttpServletRequest request, String title, Object content) {
        ...
        String str;
        if (content == null) str = "";
        else if (content instanceof String) str = (String) content;
        else str = Json.stringify(content);
    ...
    public void addLogIfSuccess(ApiJsonResult apiJsonResult, HttpServletRequest request, String title, Object content) {
        if (apiJsonResult.getCode() == ApiJsonResult.CODE_SUCCESS) addLog(request, title, content);
    }
