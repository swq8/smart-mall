...
import smart.entity.RegionEntity;
import smart.util.Json;
import smart.lib.Region;
import smart.repository.RegionRepository;
...
public class RegionCache {
    ...
    public static synchronized void update() {
        ...
        provinces1.forEach(province -> province.getChildren().forEach(city -> {
            regionEntities.forEach(regionEntity -> {
        ...
        regionJson = Json.stringify(provinces);
    }
